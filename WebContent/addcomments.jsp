...
s.src = '//8gwifi-org.disqus.com/embed.js';
...
<script>(function(d, s, id) {
 ...
 js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.1&appId=148972746053787&autoLogAppEvents=1';
 fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>

<div class="fb-comments" data-href="https://8gwifi.org/docs/<%=request.getRequestURI() %>" data-numposts="5"></div> --%>